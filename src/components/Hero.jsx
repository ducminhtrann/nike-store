  ...
  return (
    <>
      <div className="relative h-auto flex flex-col">
        <div
          className="bg-theme clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:[55vh]
        w-auto absolute top-0 left-0 right-0 opacity-100 z-10"
        ></div>
        <div className="relative opacity-100 z-20 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            <h1
              className="text-6xl lg:text-5xl md:text-4xl sm:text-3xl xs:text-2xl
            ...
            <div
              className="grid items-center absolute top-[33vh] lg:top-[27vh]
            right-0 gap-3"
            >
          ...
          <div>
            <img
              src={img}
              alt="hero-img/img"
              className="w-auto h-[45vh] lg:h-[35vh] md:h-[32vh]
            sm:h-[21vh] xs:h-[29vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill"
            />
          </div>
        </div>
      </div>
