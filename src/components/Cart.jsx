      ...
      >
        ...
        >
          ...
          {cartItems.length === 0 ? (
            ...
            <div>
              <div
                className="flex items-start flex-col gap-y-7
                lg:gap-y-5 overflow-y-scroll h-[85vh] scroll-smooth scroll-hidden py-3"
              >
                {cartItems?.map((item, i) => (
                  <CartItem key={i} item={item} />
                ))}
              </div>
              <div className="fixed bottom-0 w-full bg-white px-5 py-2 grid items-center">
